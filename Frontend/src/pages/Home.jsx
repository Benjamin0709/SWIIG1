  ...
  return (
    <div className="bg-gray-100 min-h-screen">
        ...
        <div className="w-full md:w-[90%] lg:w-[80%] max-w-6xl rounded-xl overflow-hidden shadow-xl relative">
          ...
          >
            {slides.map((slide, i) => (
              <div
                key={i}
                className="min-w-full h-56 sm:h-72 md:h-96 lg:h-10.5 relative"
              >
                <img
                  src={slide.image}
                  alt={slide.title}
      ...
      <section className="py-10 md:py-16 px-4 md:px-6 max-w-6xl mx-auto grid md:grid-cols-2 gap-8 md:gap-10 items-center">
        ...
        <img
          src="https://images.pexels.com/photos/4100420/pexels-photo-4100420.jpeg?auto=compress&cs=tinysrgb&w=800"
          alt="Sesión psicológica"
          loading="lazy"
          className="rounded-xl shadow-lg w-full h-56 sm:h-64 md:h-80 object-cover"
        />
        ...
        <div>
          ...
          <p className="text-gray-600 mb-4 text-sm md:text-base">
            Brindamos atención psicológica profesional con enfoque personalizado,
            utilizando herramientas modernas para mejorar tu bienestar.
          </p>
          ...
          <ul className="space-y-2 text-gray-700 text-sm md:text-base">
            ...
            <li>✔ Atención online y presencial</li>
          </ul>
        </div>
      </section>
      ...
      <div className="flex flex-col sm:flex-row justify-center items-center gap-4 sm:gap-6 pb-12 md:pb-16 px-4">
        ...
        <button className="w-full sm:w-auto bg-gray-800 text-white px-6 py-2 rounded hover:bg-gray-700 transition font-semibold">
          Agendar cita
        </button>
